...
class DataProcessor(object):
    ...
    def over_sampling(self, X, Y):
        ...
        for tokens, label in zip(X, Y):
            ...
            if len(list(set(label))) > 1:
                ...
                pass #used to be 'continue' (not adding empty paragraphs)
    ...
    @classmethod
    def _read_conll(cls, input_path):
...
if __name__ == '__main__':
    ...
    processor.split_train_test(
        input_file=args.input_files, output_dir=args.output_dir)
