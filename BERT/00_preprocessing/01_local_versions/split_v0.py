...
class DataProcessor(object):
    ...
    def split_train_test(self, input_file, output_dir, ratio=0.2):
    ...
    def _read_conll(cls, input_file):
        with open(input_file, 'r', encoding = 'utf-8', errors = 'ignore') as f:
            ...
            for line in f:
                ###
                line = line.replace('\u02da', '_')
                line = line.replace('\u03bc', '_')
                line = line.replace('\u03b4', '_')
                line = line.replace('\u2264', '_')
                line = line.replace('\u2265', '_')
                line = line.replace('\u2212', '_')
                line = line.replace('\ufffd', '_')
...
input_path = 'C:\\Users\\siban\\Dropbox\\CSAIL\\Projects\\02_Github\\takeda_nlp\\00_data\\02_CONLL\\CONLL_merged'
output_dir = 'C:\\Users\\siban\\Dropbox\\CSAIL\\Projects\\02_Github\\takeda_nlp\\00_data\\02_CONLL'
processor = DataProcessor(oversample_rate=1)
processor.split_train_test(input_file = input_path, output_dir = output_dir)
