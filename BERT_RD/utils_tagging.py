...
InputFeatures = namedtuple("InputFeatures", "input_ids input_mask p1_mask p2_mask segment_ids label_ids")
...
ALL_FIELDS = {'ner': {'conll03': Fields(word_column=0, tag_column=-1),
                      ...
                      'takeda': Fields(word_column=0, tag_column=-1),
...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        if self.tagset == "conll03_seg":
            ...
            return ["O",
                    "B-Reactants", "I-Reactants",
                    "B-Catalyst", "I-Catalyst",
                    "B-Reagents", "I-Reagents",
...
def convert_examples_to_features(examples, label_list, max_seq_length,
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        p1_mask = [0 for i in range(len(input_mask))]
        p1_mask[p1_p] = 1
        p2_mask = [0 for i in range(len(input_mask))]
        p2_mask[p2_p] = 1
